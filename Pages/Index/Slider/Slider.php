    ...
    <div class="sliderRelative">
          ...
          <div class="sliderRelative">
            <div class="slider1">
              ...
              <div class="containerTextSlider1">
                <p>As the future moves more and more towards contactles and hands free actions -what better way to carry your ID card, keys, passes, tickets etc than on a </p>
                <h2>LANYARD</h2>
      ...
      <div class="slider">
        <div class="slider2">
          ...
          <p>Hands free, light and comfortable to wear, hard to lose
            We have all the options to fit around any neck!</p> <br>
      ...
      <div class="slider">
        <div class="slider2">
          ...
          <p>Material can be tubular, polyester, bamboo, woven--there are many choices.
          There are even LED light up lanyards...  </p><br>
          <p>The width of the lanyard can be for comfort or to accommodate your logo </p> <br>
          <p>If in doubt work a 20mm or 15mm dye sublimated polyester lanyard-- eveeryone loves this one and
